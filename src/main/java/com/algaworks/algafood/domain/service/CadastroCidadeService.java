...
public class CadastroCidadeService {
	...
	private static final String MSG_NAO_EXISTE_UM_CADASTRO_DE_CIDADE = "Não existe um cadastro de cidade com código %d";
	...
	public void excluir(Long cidadeId) {
		try {
			...
			throw new EntidadeNaoEncontradaException(String.format(MSG_NAO_EXISTE_UM_CADASTRO_DE_CIDADE, cidadeId));
	...
	public Cidade buscarOuFalhar(Long cidadeId) {
		return cidadeRepository.findById(cidadeId).orElseThrow(() -> new EntidadeNaoEncontradaException(
				String.format(MSG_NAO_EXISTE_UM_CADASTRO_DE_CIDADE, cidadeId)));
	}
